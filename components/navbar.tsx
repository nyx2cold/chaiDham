...
import {
  ...
  FileText, Coffee, Truck, CheckCircle2, ChevronUp,
} from "lucide-react";
...
export default function Navbar() {
  ...
  useEffect(() => {
    try {
      localStorage.setItem("chaidham_orders", JSON.stringify(placedOrders));
    } catch { }
  }, [placedOrders]);
  ...
  const toggleCollapse = (id: string) =>
    setCollapsedOrders((p) => ({ ...p, [id]: !p[id] }));
  ...
  return (
    <>
            ...
            {isLoading ? (
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button
                    className="inline-flex items-center gap-2 rounded-full outline-none
      ...
      whitespace-nowrap group"
        ...
        group-hover:border-amber-500/40 transition-all duration-200">
                      <AvatarFallback
                        className={
                          isAdmin
                    ...
                    <span
                      className="hidden xs:inline-block sm:inline-block max-w-[120px] truncate
        text-sm font-medium text-white leading-none"
                ...
                <DropdownMenuContent
                  align="end"
                  sideOffset={8}
                  className="relative w-56 rounded-2xl p-1.5 overflow-hidden
      bg-black backdrop-blur-md
      border border-white/10
      shadow-lg
      [&_[data-highlighted]]:bg-white/5 [&_[data-highlighted]]:text-white
      ...
      flex flex-col h-full rounded-2xl overflow-hidden
                ...
                >
                  ...
                  <div className="relative px-3 py-2.5 mb-1">
                    {isAdmin && (
                      <span
                        className="inline-flex items-center mb-2 px-1.5 py-0.5 rounded-md
        ...
        transition-all duration-150 data-[highlighted]:bg-white/5 data-[highlighted]:text-white"
                    >
        ...
        transition-all duration-150 data-[highlighted]:bg-white/5 data-[highlighted]:text-white"
                  ...
                  <DropdownMenuItem
                    ...
                    className="rounded-xl px-3 py-2 cursor-pointer outline-none
    ...
    ${drawerOpen ? "translate-x-0" : "translate-x-full"}`}
      >
        {/* ── Glass shell (same as OrdersTable) ── */}
        <div className="absolute inset-0
    bg-gradient-to-br from-white/[0.07] via-white/[0.03] to-white/[0.05]
    backdrop-blur-2xl
    border-l border-white/[0.10]
    shadow-[-20px_0_60px_rgba(0,0,0,0.5),inset_1px_0_0_rgba(255,255,255,0.08),inset_0_1px_0_rgba(255,255,255,0.10)]
    pointer-events-none"
        />
        ...
        <div className="pointer-events-none absolute top-1/2 -left-8 h-32 w-32 rounded-full bg-amber-500/[0.06] blur-2xl" /> */}
    ...
    shrink-0"
        ...
        shadow-[0_0_16px_rgba(245,158,11,0.15)]"> */}
          ...
          bg-amber-500 px-1.5 text-[10px] font-bold text-zinc-950
        ...
        text-zinc-400 hover:text-white hover:bg-white/[0.12]
        ...
        <div className="relative flex-1 overflow-y-auto">
          ...
          {placedOrders.length > 0 && (
            <div className="px-4 pt-4 space-y-3">
              <p className="text-[11px] text-zinc-500 uppercase tracking-wider font-semibold px-0.5">
                Your Orders
              </p>
              ...
              {placedOrders.map((order) => {
                ...
                return (
                  <div key={order.orderId} className="relative rounded-2xl overflow-hidden">
                    {/* Glass shell per order card */}
                ...
                pointer-events-none`}
                  ...
                  h-12 w-24 rounded-full bg-amber-500/10 blur-2xl" />
                    )}
                    ...
                    [text-shadow:0_0_12px_rgba(245,158,11,0.4)]">
                    ...
                    <div style={{
                      ...
                      <div className="relative px-4 pb-4 pt-1 border-t border-white/[0.06] space-y-1">
                        {STATUS_STEPS.map((step, i) => {
                          ...
                          ${isActiveStep
                                  ? "bg-amber-500/10 border-amber-500/20 shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_0_16px_rgba(245,158,11,0.06)]"
                                  : isDoneStep
                              ...
                              ${isActiveStep ? "text-amber-300" : isDoneStep ? "text-emerald-400" : "text-zinc-600"}`}>
                                ...
                                {isActiveStep && (
                                  <span className="animate-pulse relative inline-flex rounded-full h-2 w-2 bg-amber-500 shrink-0" />
                                )}
                              </div>
                              {i < STATUS_STEPS.length - 1 && (
                                <div className={`ml-[22px] w-px h-2.5
                            ${isDoneStep ? "bg-emerald-500/20" : "bg-white/[0.05]"}`}
                                />
                              )}
                            </div>
                          );
          ...
          <div className="px-4 py-4 space-y-3">
            ...
            shadow-[0_8px_32px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.10),0_0_0_8px_rgba(255,255,255,0.02)]">
              ...
              cartItems.map((item) => (
                <div key={item._id} className="relative rounded-2xl overflow-hidden group">
                  {/* Glass shell per cart item */}
                  <div className="absolute inset-0 rounded-2xl
              bg-gradient-to-br from-white/[0.07] via-white/[0.03] to-white/[0.04]
              backdrop-blur-sm
              border border-white/[0.08]
              group-hover:border-white/[0.14] group-hover:from-white/[0.09]
              shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]
              transition-all duration-200 pointer-events-none"
                ...
                flex items-center justify-center overflow-hidden">
                    ...
                    <div className="flex flex-1 flex-col gap-1 min-w-0">
                      ...
                      <p className="text-xs font-bold text-amber-400 [text-shadow:0_0_10px_rgba(245,158,11,0.3)]">
                        ₹{item.price}
                      </p>
                      <div className="flex items-center gap-2 mt-auto">
                        <button onClick={() => updateQuantity(item._id, item.quantity - 1)}
                          className="flex h-6 w-6 items-center justify-center rounded-md
                      bg-white/[0.06] hover:bg-white/[0.14] backdrop-blur-sm
                    ...
                    <div className="flex flex-col items-end justify-between flex-shrink-0">
                      <button onClick={() => removeFromCart(item._id)}
                        className="flex h-7 w-7 items-center justify-center rounded-lg
                    border border-red-500/[0.18] bg-red-500/[0.07] backdrop-blur-sm
                    text-red-500/50 hover:text-red-400 hover:bg-red-500/[0.18]
                  ...
                  ${expandedNotes[item._id] ? "rotate-180" : ""}`} />
                    </button>
                    <div style={{
        ...
        {cartItems.length > 0 && (
          <div className="relative px-4 pt-4 pb-5 space-y-3 shrink-0">
            {/* Glass footer shell */}
            <div className="absolute inset-0
        bg-gradient-to-t from-black/40 via-white/[0.03] to-transparent
        backdrop-blur-sm border-t border-white/[0.08]
        shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]
        pointer-events-none"
            />
            ...
            <p className="relative text-[11px] text-zinc-600">
              Taxes and delivery calculated at checkout
            </p>

            <div className="relative flex rounded-xl overflow-hidden
        border border-white/[0.10] bg-white/[0.03] backdrop-blur-sm
        shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
              <button
            ...
            ${orderType === "dine-in"
                    ? "bg-amber-500 text-zinc-950 shadow-[0_0_20px_rgba(245,158,11,0.3)]"
            ...
            <button
              ...
              className="relative w-full py-3 rounded-xl font-bold text-sm text-zinc-950
          bg-amber-500 hover:bg-amber-400
          shadow-[0_4px_24px_rgba(245,158,11,0.35),inset_0_1px_0_rgba(255,255,255,0.2)]
          hover:shadow-[0_4px_32px_rgba(245,158,11,0.5)]
